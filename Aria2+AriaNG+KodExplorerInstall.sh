...
echo "# Website:https://gynl.xyz转载 https://www.lala.im           #"
...
echo "# AriaNG WebSite: http://${HostIP}:1585                     #"
echo "# KodExplorer WebSite: http://${HostIP}:1586                #"
echo "# Default Aria2 RPC Password: gynl.xyz                       #"
